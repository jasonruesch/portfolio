...
export function ThemeSelector({ className }: { className?: string }) {
  ...
  return (
    <Menu as="div" className="relative">
      ...
      >
        <Menu.Items className="bg-surface absolute right-0 z-50 mt-2 w-48 origin-top-right rounded-md py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dark:shadow-black dark:ring-opacity-50">
          <Menu.Item>
            {({ active }) => (
              <button
                className={classNames(
